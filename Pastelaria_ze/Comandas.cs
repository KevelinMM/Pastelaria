    ...
    public partial class Comandas : Form
    {
        ...
        private void ButtonComandaBuscar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dataGridViewPodutos.Columns.Clear();
                dataGridViewPodutos.AutoGenerateColumns = true;
                dataGridViewPodutos.DataSource = linhas;
                dataGridViewPodutos.Refresh();
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        {
            if (dataGridViewPodutos.SelectedCells.Count > 0)
            {
        ...
        private void dataGridViewPodutos_DoubleClick(object sender, EventArgs e)
        {
            if (dataGridViewPodutos.SelectedCells.Count > 0)
            {
                //pega o ID e o NUMERO da comanda selecionada
                ...
                DataGridViewRow selectedRowProduto = dataGridViewPodutos.Rows[dataGridViewPodutos.SelectedCells[0].RowIndex];
